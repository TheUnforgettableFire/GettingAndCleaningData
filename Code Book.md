...
The six factor levels in y_test and y_train were assigned the names included in the file activity_labels.txt.
Similarly, for the X_test and X_train the variables (561) were assigned based on values included in the file features.txt.

After merging the three training data sets and test data sets, we subset the data by selecting variables that ended with -mean() and -sd().
This results in 66 out of the 561 variables.
